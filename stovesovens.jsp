...
<head>
	...
	<script type="text/javascript">
		function validate()	{
			...
			if(pid!="so1" && pid!="so2" && pid!="so3" && pid!="so4" && pid!="so5" && pid!="so6")	{
...
<div class="i1">
    <a href="#"><img src="${pageContext.request.contextPath}/images/stoves/stove1.jpg"></a>
</div>
<div class="i2">
    <a href="#"><img src="${pageContext.request.contextPath}/images/stoves/stove2.jpg"></a>
</div>
<div class="i3">
    <a href="#"><img src="${pageContext.request.contextPath}/images/stoves/stove3.jpg"></a>
</div>
<div class="i4">
    <a href="#"><img src="${pageContext.request.contextPath}/images/stoves/stove4.jpg"></a>
</div>
<div class="i5">
    <a href="#"><img src="${pageContext.request.contextPath}/images/stoves/stove5.png"></a>
</div>
<div class="i6">
    <a href="#"><img src="${pageContext.request.contextPath}/images/stoves/stove6.png"></a>
</div>
<div class="prod1">
	<h3>ID : so1<br>COST : Rs 1000<br>ARRIVAL TIME : 1 DAYS<h3>
</div>
<div class="prod2">
	<h3>ID : so2<br>COST : Rs 2000<br>ARRIVAL TIME : 2 DAYS<h3>
</div>
<div class="prod3">
	<h3>ID : so3<br>COST : Rs 3000<br>ARRIVAL TIME : 3 DAYS<h3>
</div>
<div class="prod4">
	<h3>ID : so4<br>COST : Rs 4000<br>ARRIVAL TIME : 4 DAYS<h3>
</div>
<div class="prod5">
	<h3>ID : so5<br>COST : Rs 5000<br>ARRIVAL TIME : 5 DAYS<h3>
</div>
<div class="prod6">
	<h3>ID : so6<br>COST : Rs 6000<br>ARRIVAL TIME : 6 DAYS<h3>
</div>

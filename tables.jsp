...
<head>
	...
	<script type="text/javascript">
		function validate()	{
			...
			if(pid!="table1" && pid!="table2" && pid!="table3" && pid!="table4" && pid!="table5" && pid!="table6")	{
...
<div class="i1">
    <a href="#"><img src="${pageContext.request.contextPath}/images/tables/table1.jpg"></a>
</div>
<div class="i2">
    <a href="#"><img src="${pageContext.request.contextPath}/images/tables/table2.jpg"></a>
</div>
<div class="i3">
    <a href="#"><img src="${pageContext.request.contextPath}/images/tables/table3.jpg"></a>
</div>
<div class="i4">
    <a href="#"><img src="${pageContext.request.contextPath}/images/tables/table4.jpg"></a>
</div>
<div class="i5">
    <a href="#"><img src="${pageContext.request.contextPath}/images/tables/table5.jpg"></a>
</div>
<div class="i6">
    <a href="#"><img src="${pageContext.request.contextPath}/images/tables/table6.jpg"></a>
</div>
<div class="prod1">
	<h3>ID : table1<br>COST : Rs 1000<br>ARRIVAL TIME : 1 DAYS<h3>
</div>
<div class="prod2">
	<h3>ID : table2<br>COST : Rs 2000<br>ARRIVAL TIME : 2 DAYS<h3>
</div>
<div class="prod3">
	<h3>ID : table3<br>COST : Rs 3000<br>ARRIVAL TIME : 3 DAYS<h3>
</div>
<div class="prod4">
	<h3>ID : table4<br>COST : Rs 4000<br>ARRIVAL TIME : 4 DAYS<h3>
</div>
<div class="prod5">
	<h3>ID : table5<br>COST : Rs 5000<br>ARRIVAL TIME : 5 DAYS<h3>
</div>
<div class="prod6">
	<h3>ID : table6<br>COST : Rs 6000<br>ARRIVAL TIME : 6 DAYS<h3>
</div>

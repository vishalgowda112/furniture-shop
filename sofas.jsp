...
<head>
	...
	<script type="text/javascript">
		function validate()	{
			...
			if(pid!="sofa1" && pid!="sofa2" && pid!="sofa3" && pid!="sofa4" && pid!="sofa5" && pid!="sofa6")	{
...
<div class="i1">
    <a href="#"><img src="${pageContext.request.contextPath}/images/sofas/sofa1.jpg"></a>
</div>
<div class="i2">
    <a href="#"><img src="${pageContext.request.contextPath}/images/sofas/sofa2.jpg"></a>
</div>
<div class="i3">
    <a href="#"><img src="${pageContext.request.contextPath}/images/sofas/sofa3.jpg"></a>
</div>
<div class="i4">
    <a href="#"><img src="${pageContext.request.contextPath}/images/sofas/sofa4.jpg"></a>
</div>
<div class="i5">
    <a href="#"><img src="${pageContext.request.contextPath}/images/sofas/sofa5.jpg"></a>
</div>
<div class="i6">
    <a href="#"><img src="${pageContext.request.contextPath}/images/sofas/sofa6.jpg"></a>
</div>
<div class="prod1">
	<h3>ID : sofa1<br>COST : Rs 1000<br>ARRIVAL TIME : 1 DAYS<h3>
</div>
<div class="prod2">
	<h3>ID : sofa2<br>COST : Rs 2000<br>ARRIVAL TIME : 2 DAYS<h3>
</div>
<div class="prod3">
	<h3>ID : sofa3<br>COST : Rs 3000<br>ARRIVAL TIME : 3 DAYS<h3>
</div>
<div class="prod4">
	<h3>ID : sofa4<br>COST : Rs 4000<br>ARRIVAL TIME : 4 DAYS<h3>
</div>
<div class="prod5">
	<h3>ID : sofa5<br>COST : Rs 5000<br>ARRIVAL TIME : 5 DAYS<h3>
</div>
<div class="prod6">
	<h3>ID : sofa6<br>COST : Rs 6000<br>ARRIVAL TIME : 6 DAYS<h3>
</div>
